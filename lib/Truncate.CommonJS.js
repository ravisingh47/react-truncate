...
var Truncate = function (_Component) {
    ...
    _createClass(Truncate, [{
        ...
        value: function calcTargetWidth(callback) {
            ...
            var extraWidthReduction = this.props.extraWidthReduction;
            ...
            var targetParentStyles = window.getComputedStyle(target.parentNode);
            var targetParentPadding = parseFloat(targetParentStyles.paddingLeft) + parseFloat(targetParentStyles.paddingRight);
            var targetWidth = Math.floor(target.parentNode.getBoundingClientRect().width - targetParentPadding - extraWidthReduction);
...
Truncate.propTypes = {
    ...
    extraWidthReduction: _propTypes2.default.number
};
